...
def process_unknown_messages(ti):
...
with DAG(
    ...
    unknown_messages = PythonOperator(
        task_id="process_unknown_messages", python_callable=process_unknown_messages
    )
    delete_original_messages = PythonOperator(
        task_id="delete_original_messages", python_callable=delete_original_messages
    )

    [error_messages, success_messages, warning_messages, unknown_messages] >> delete_original_messages
